...
public class SpiralParticleRenderer extends AbstractParticleRenderer implements ParticleRenderer {
	...
	private final Logger logger = LoggerFactory.getLogger(SpiralParticleRenderer.class);

	public SpiralParticleRenderer() {}
