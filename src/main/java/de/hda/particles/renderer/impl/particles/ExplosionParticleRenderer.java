...
public class ExplosionParticleRenderer extends AbstractParticleRenderer implements ParticleRenderer {

	public final static String NAME = "Explosion";

	public ExplosionParticleRenderer() {}

	@Override
	public void before() {
		glPushMatrix();
		glEnable(GL_TEXTURE_2D);
		scene.getTextureManager().load("PNG", "images/particles/explosion.png").bind();
		glEnable(GL_BLEND);
		...
		glPointParameterfARB( GL_POINT_SIZE_MIN_ARB, 60.0f );
