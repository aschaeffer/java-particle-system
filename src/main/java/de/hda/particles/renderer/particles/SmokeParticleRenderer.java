...
public class SmokeParticleRenderer extends AbstractParticleRenderer implements ParticleRenderer {

	public final static String NAME = "Smoke";

	public SmokeParticleRenderer() {}
	...
	public void before() {
		...
		glPointParameterfARB( GL_POINT_FADE_THRESHOLD_SIZE_ARB, 135.0f );
		//Tell it the max and min sizes we can use using our pre-filled array.
		glPointParameterfARB( GL_POINT_SIZE_MIN_ARB, 100.0f );
		glPointParameterfARB( GL_POINT_SIZE_MAX_ARB, 300.0f );
