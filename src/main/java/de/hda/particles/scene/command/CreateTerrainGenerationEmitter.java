...
public class CreateTerrainGenerationEmitter implements Command {

	private final Logger logger = LoggerFactory.getLogger(CreateTerrainGenerationEmitter.class);
