...
public class AddFieldEmitter implements Command {

	private final Logger logger = LoggerFactory.getLogger(AddFieldEmitter.class);
	...
	public DemoHandle execute(DemoContext context, CommandConfiguration configuration, Integer transitionIterations) {
		...
		while (iterator.hasNext()) {
			...
			PooledFieldParticleEmitter emitter = new PooledFieldParticleEmitter();
