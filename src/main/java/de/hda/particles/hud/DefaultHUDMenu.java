...
/**
 * This class generates the menu structure.
 * 
 * @author aschaeffer
 *
 */
public class DefaultHUDMenu {
	...
	public HUDMenuEntry createMenu(Scene s) {
		...
		HUDMenuEntry renderTypes = HUDMenuEntry.create(scene, "Particle Renderers");
		HUDMenuEntry addPointSpriteRenderTypes = HUDMenuEntry.create(renderTypes, "Add Point Sprite Particle Renderer");
		HUDMenuEntry addPrimitiveRenderTypes = HUDMenuEntry.create(renderTypes, "Add Primtive Particle Renderer");
		HUDMenuEntry addComplexRenderTypes = HUDMenuEntry.create(renderTypes, "Add Complex Particle Renderer");
		HUDMenuEntry addMassSpringRenderTypes = HUDMenuEntry.create(renderTypes, "Add Mass Spring Particle Renderer");
		HUDMenuEntry addPositionPathRenderTypes = HUDMenuEntry.create(renderTypes, "Add Position Path Particle Renderer");
		HUDMenuEntry addTechnicalRenderTypes = HUDMenuEntry.create(renderTypes, "Add Technical Particle Renderer");
		...
		HUDMenuEntry.create(addPositionPathRenderTypes, "Spiral", HUDCommandTypes.ADD_RENDER_TYPE, SpiralRenderType.class);
		...
		HUDMenuEntry.create(addTechnicalRenderTypes, "NULL", HUDCommandTypes.ADD_RENDER_TYPE, NullRenderType.class);
		HUDMenuEntry.create(addTechnicalRenderTypes, "Velocity Indicator", HUDCommandTypes.ADD_RENDER_TYPE, VelocityIndicatorRenderType.class);
		...
		HUDMenuEntry.create(addHUD, "RenderTypeHUD", HUDCommandTypes.ADD_HUD, RenderTypeHUD.class);
		...
		HUDMenuEntry.create(removeHUD, "RenderTypeHUD", HUDCommandTypes.REMOVE_HUD, RenderTypeHUD.class);
		...
		HUDMenuEntry.create(windowSize, "640x480", HUDCommandTypes.DISPLAY_SIZE, 640, 480);
		HUDMenuEntry.create(windowSize, "800x600", HUDCommandTypes.DISPLAY_SIZE, 800, 600);
		HUDMenuEntry.create(windowSize, "1024x768", HUDCommandTypes.DISPLAY_SIZE, 1024, 768);
		HUDMenuEntry.create(windowSize, "1280x720", HUDCommandTypes.DISPLAY_SIZE, 1280, 720);
		HUDMenuEntry.create(windowSize, "1366x768", HUDCommandTypes.DISPLAY_SIZE, 1366, 768);
		HUDMenuEntry.create(windowSize, "1920x1080", HUDCommandTypes.DISPLAY_SIZE, 1920, 1080);
